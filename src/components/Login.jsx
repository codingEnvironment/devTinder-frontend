...
const Login = () => {
  ...
  return (
    <fieldset className="fieldset bg-base-200 border-base-300 rounded-box w-xs border p-4" style={{ margin: '100px auto' }}>
      ...
      <input type="email" className="input" placeholder="Email" ref={emailRef} defaultValue="mahesh@gmail.com" />

      <label className="label">Password</label>
      <input type="password" className="input" placeholder="Password" ref={passwordRef} defaultValue="m1234" />
